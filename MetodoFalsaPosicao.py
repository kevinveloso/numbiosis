...
#funcao
def f(x):
  expressao = float(x**10) - 1 
  return expressao


def falsaposicao(a, b, tol, Ni):
...
a = float(input("aproximacao a: "))
b = float(input("aproximacao b: "))
c = float(input("Numero de Iteracoes: "))   
d = float(input("Tolerancia(ex: 0.03): "))

falsaposicao(a, b, d, c)
